...
import TransferenciaSaldos from "./transferencia/TransferenciaSaldos";
import FormTransferenciaSaldos from "./transferencia/FormTransferenciaSaldos";
import {configTransferModal, showTransferModal} from "../../../reducers/bodega/egresoBodegaDucks";
import TransferenciaDetail from "./transferencia/TransferenciaDetail";

export default function DetallesEgreso() {
                ...
                <div className="col-12 table-responsive">
                    <table className="table table-bordered table-hover">
                        ...
                        {despachos.map((data, i) =>
                            !data.hasOwnProperty('delete') && <DetalleEgreso key={i} index={i} data={data}/>
                        )}
