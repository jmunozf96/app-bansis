...
export default function Mapa({coordenadas}) {
    //Centro Primo -2.2532148580138966, -79.49621200561525.
    //Centro Sofca -2.2662080954625723, -79.4950318336487.
    ...
    return (
        ...
        >
            ...
            />
            {coordenadas.length > 0 && coordenadas.map((item, i) =>
                <Marker
                    key={i}
                    position={[item.coordenadas.latitud, item.coordenadas.longitud]}
                    icon={myIcon}
                >
                    <Popup>
                        <p className="mb-2">Cintas cortadas en lote: {item.title}</p>
